...
6. `docs/backlog-decisiones-owner-migracion.md` (Fase 3 cerrada, v1.28; OWN-020 / D-08 pendiente issue #5; OWN-021 / D-09 overflow Sangha dejado al corte, wrap post-corte issue #7; OWN-022 / D-10 `wp-emoji` `sessionStorage` aceptado; `POST-*` = fases posteriores, no bloquear el corte)
