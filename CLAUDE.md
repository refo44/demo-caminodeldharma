...
- Production: WordPress on the canonical domain since 2026-09-26.
  ...
  The old static site remains on the palegreen temporary domain for rollback.
  Do not delete it or the private backups. Contact-form email is unverified
...
- Deploy: manual ZIP from `static/` (ADR 0015). WordPress: **Fase 3**
  ...
  a second WordPress. The static rollback site remains at
  `https://palegreen-cod-365706.hostingersite.com/`; do not delete it. Do not
