...
- → Si hay un evento vigente, ve el rótulo «Próximo evento», el cartel y puede abrir esa ficha con el cartel, el título o «Ver evento» (atajo; no sustituye al menú Eventos ni enlaza el listado)
...
**Versión:** 1.5 — Inicio: cartel, título y «Ver evento» abren la ficha vigente.
