...
(`backlog-decisiones-owner-migracion.md`: Fase 3 cerrada v1.28; OWN-020 / D-08 pendiente de
código; OWN-021 / D-09 overflow dejado al corte; OWN-022 / D-10 `wp-emoji` aceptado; POST-008 wrap post-corte; `POST-*` i18n no se
implementan
