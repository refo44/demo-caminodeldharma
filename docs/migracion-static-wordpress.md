...
| 2026-08-31 | **BUG-001:** `.ics` de Círculos debe incluir **todas las sesiones**. Estático = solo bienvenida; WP WU-08A = un VEVENT de rango. Sesión propia **justo antes de WU-10** (después de WU-09) | No (estático intacto hasta esa sesión) | Sí — generador + diálogo, misma fuente; `event_calendar_dates` ya existe | Pendiente (antes de WU-10) |
