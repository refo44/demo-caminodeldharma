...
| **Pestaña 7** | En producción: `galeria-01.jpg` … `galeria-36.jpg` (kebab-case, sin espacios, orden numérico). Ver `scripts/rename-gallery-to-kebab.sh`. | **Página Galería** (`/galeria/`): álbum **General** (`galeria-01` … `galeria-26`, destacadas al inicio), **2023** (`galeria-27` … `galeria-31`) y **2021** (`galeria-32` … `galeria-36`). `gallery-data` conserva el inventario y `gallery-albums-data` define la agrupación; en el CMS, cada imagen deberá asociarse editorialmente a un álbum. Preview en inicio: `galeria-01` … `galeria-04`. |
