...
| - | ---------- | ---------- |
| 1 | **CONTENT** | Objetos en la base de datos y media: Pages, posts, CPT `event`, CPT `blog_author` (ADR 0037; `seo`/bio/thumb de ficha OWN-020 en el payload, plugin 0.7.7, [#5](https://github.com/refo44/demo-caminodeldharma/issues/5)), taxonomía de álbum (ADR 0036), `sangha` solo si una decisión posterior lo activa, metadata, biblioteca de medios, copy institucional. |
