...
| CPT `blog_author` | **2** | Zheng Gong + Comunidad Camino del Dharma; `seo`/bio/thumb OWN-020 en el payload (plugin 0.7.7, [#5](https://github.com/refo44/demo-caminodeldharma/issues/5)) |
