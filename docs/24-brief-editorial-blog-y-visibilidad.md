...
## 3. SEO en lenguaje claro

**SEO** (*optimización para buscadores*) significa, en la práctica: que quien busca un tema **encuentre una página útil**.

Para el blog **no** significa:

- repetir palabras clave a la fuerza;
- escribir textos largos “por obligación”;
- sonar comercial o urgente;
- traicionar la voz serena de la comunidad.
...
| Capa | Quién | Estado |
|---|---|---|
| Técnica (sitio, velocidad, enlaces rotos) | Equipo de publicación web | En buen estado |
| Editorial (artículos del blog) | **Equipo editorial** | Aquí está la brecha que señala el audit |

---

## 4. Cómo el blog ayuda a aparecer en las búsquedas
...
Unos **tres meses** después de publicar, en **Google Search Console** (herramienta gratuita de Google) se puede mirar:

- si hay **impresiones** en temas distintos del nombre de la marca;
...
**¿El artículo de meditación online repite la página Práctica?**  
