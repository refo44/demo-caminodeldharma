...
| **Future** | Rest of Fase 3: **live static production → FSE block theme** (ADR 0029). No classic PHP theme in between. Next work unit: WU-06 — deterministic extractor, versioned migration payload, WP-CLI importer (validate/plan/import/verify, dry-run by default), real-media `seed`, count reconciliation. |
