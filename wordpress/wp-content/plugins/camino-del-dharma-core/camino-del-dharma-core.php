...
require_once __DIR__ . '/includes/migration/class-cdd-core-author-profile-extractor.php';
...
if ( function_exists( 'add_action' ) ) {
	...
	add_action( 'wp_after_insert_post', 'cdd_core_seo_backfill_meta', 10, 2 );
