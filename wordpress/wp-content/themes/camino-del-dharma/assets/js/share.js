/**
 * Camino del Dharma (theme FSE) - share dialog.
 * Ported verbatim from static/assets/js/share.js (WU-08A). The trigger
 * markup and the <template> message bodies come from the
 * evento-acciones and entrada-compartir blocks, which print the
 * share_whatsapp / share_x / share_threads meta.
 */
(function () {
