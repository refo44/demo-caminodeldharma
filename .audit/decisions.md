...
- 2026-07-19 Phase 4A: HSTS basic host-only = ACTIVATE_HSTS_NOW; includeSubDomains REJECTED (inventory not enumerable); preload REJECTED (not candidate). Rationale and evidence in hsts-decision.md.
