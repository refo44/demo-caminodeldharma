...
**Causas:** autoridad externa casi nula — **cuantificada el 2026-07-20: DR 0,4 / DA 6** (ver adenda de autoridad) —, índice contaminado por residuos de WordPress, cero señales locales (el sitio no declaraba dónde ni cuándo se fundó la comunidad) y contenido temático mínimo (1 entrada de blog).

**Hecho en esta continuación (en fuente, pendiente de deploy — TASK-0013):** redirects 410/301 para las URLs residuales, datos estructurados con fundación y `knowsAbout`, mención de la fundación en home y comunidad, títulos temáticos en eventos y blog.

> **Corrección del 2026-07-28 — dato de fundación.** Los datos de fundación se publicaron como **«Cali, 2012»**, tomados del artículo de Buddhistdoor (EVID-0035) y no de la comunidad. El Venerable Maestro Zheng Gong los corrigió: **la comunidad se fundó en Colombia, en 2019**, y no en una sola ciudad. Rectificados el JSON-LD de la portada y las menciones visibles de portada y `/comunidad`. **Consecuencia:** la fundación deja de ser una señal local de ciudad. Sin efecto sobre el plan — las consultas locales ya dejaron de contabilizarse como brecha alcanzable al descartarse GBP el 2026-07-21 (ver punto 1 de la adenda de correcciones), y la vía local vigente son los encuentros presenciales reales. Buddhistdoor sigue publicando el dato erróneo; pedir la corrección es una gestión nueva, ya que las peticiones de enlace de TASK-0014 se enviaron el 2026-07-20.
