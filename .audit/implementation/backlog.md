...
| 2 | TASK-0001 | IMPLEMENTED_PENDING_VALIDATION | WAVE-1 | FUNC-002 | Frontend | LT_30_MIN | LOW | — | CG-HTACCESS |
...
| 3 | TASK-0017 | READY | WAVE-2 | ASO-002 | Contenido/Frontend | 30_MIN_TO_2_HOURS | LOW | TASK-0013 | CG-HTML-GLOBAL |
| 4 | TASK-0018 | READY | WAVE-3 | ASO-001 | Contenido/Comunidad | HALF_DAY | LOW | TASK-0013 | CG-HTML-GLOBAL |
| 4 | TASK-0019 | READY | WAVE-2 | SEO-EXT-001 | Marketing/Comunidad (humano) | LT_30_MIN | LOW | — | NONE |

Nota (continuación 2026-07-20): TASK-0017–0018 provienen de la auditoría ASO/AEO (`working/aso-aeo.md`). **TASK-0001 fue corregida**: ya no consiste en crear archivos .ics (el archivo existe), sino en usar rutas absolutas + MIME `text/calendar`.
